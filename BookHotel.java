...
public class BookHotel extends JFrame {
	...
	public BookHotel(String username) {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Travel/Travel_Tourisum/book.jpg"));
		...
		contentPane.add(lblId);
                ...
                try{
                    ...
                    ResultSet rs = ((Statement) c).executeQuery("select * from hotels");
                    while(rs.next()){
		...
		contentPane.add(l5);
                ...
                try{
                    ...
                    ResultSet rs = ((Statement) c).executeQuery("select * from customer where username ="+username+"");
                    while(rs.next()){
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                ResultSet rs = ((Statement) c).executeQuery(q1);
                                if(rs.next()){
